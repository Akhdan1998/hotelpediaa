...
class ticket_detail_train extends StatelessWidget {
          ...
          children: [
            Stack(
              children: [
                ...
                Container(
                  padding: EdgeInsets.only(left: 25, right: 25, top: 86),
                  child: Positioned(
                    child: Container(
                      // height: 432,
                      width: MediaQuery.of(context).size.width,
                          ...
                          children: [
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller: keberangkatanEditingController,
                                        decoration: InputDecoration(
                                          focusedBorder: OutlineInputBorder(
                                            borderRadius: BorderRadius.circular(10),
                                            borderSide: BorderSide(color: 'C01414'.toColor()),
                                          ),
                            ...
                            Container(
                              ...
                              child: FlatButton(
                                ...
                                color: 'C01414'.toColor(),
                                onPressed: () {
                                  Get.to(daftarkeretaapi());
                                },
                                child: Text('tombolcaritiketkereta',
                                  style: GoogleFonts.poppins().copyWith(
                                      fontSize: 15,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.white),
